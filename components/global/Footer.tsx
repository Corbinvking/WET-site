  ...
  return (
    <footer className="bg-bg-dark text-text-inverse border-t border-slate-800">
      ...
      <div className="border-t border-slate-800">
        <div className="container-wet py-3 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} W.E.T. All rights reserved. Not financial advice.
          </p>
